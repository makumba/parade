...
{  
  ...
  TextboxEditor(){
    // FIXME: once more edit modes are defined, the user should be able to choose the edit mode
  ...
  public void reload()
  {
    ...
    pos.moveTo(new SourcePosition(getText(), pos.getLine(getText()), 1, 0, 0));
    setCaretPosition(pos.getPosition());
  }
  ...
  public int getIntPosition(){ return getCaretPosition(); }
}
