...
public class EditApplet extends java.applet.Applet implements StatusDisplay
{
  ...
  public void init()
  {
    ...
    if(getParameter("context")!=null)
      loadFile(getParameter("context"), getParameter("dir"), getParameter("file"), getParameter("line"), getParameter("column"), getParameter("endLine"), getParameter("endColumn"));
  }
  ...
  public void loadFile(String context, String path, String file, String line, String column, String endLine, String endColumn)
  {
    SourcePointer sp= new SourcePointer(getCodeBase(), context, path, file);
    me.loadFile(sp, 
		new SourcePosition(sp.getText(), getPosition(line), getPosition(column), getPosition(endLine), getPosition(endColumn)));
  }
