...
/** This is the interface to a generic single source file editor that uses the SourcePointer class
  to save and load sources
 * can be implemented in all sort of ways, the only constraint about editors is that they have to extend java.awt.Component
 */
