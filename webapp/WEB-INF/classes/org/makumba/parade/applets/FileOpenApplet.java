...
public class FileOpenApplet extends java.applet.Applet
{
  ...
  public void init()
  {
    ...
    final SourcePointer sp= new SourcePointer(getCodeBase(), getParameter("context"), getParameter("dir"), getParameter("file"));
    final SourcePosition pos= new SourcePosition(sp.getText(), getPosition("line"), getPosition("column"), getPosition("endLine"), getPosition("endColumn"));
  ...
  {
    public boolean imageUpdate(Image im, int status, int x, int y, int w, int h)
      {
