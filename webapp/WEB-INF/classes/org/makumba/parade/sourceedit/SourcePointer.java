...
public class SourcePointer extends Observable
{
  ...
  public String getHashString(){ return u+"#"+context+"#"+path+"#"+file; }

  public boolean getChanged(){return contentChanged; }
  ...
  public synchronized void save()
  {
    ...
    try{
      ...
      uc.setDoOutput(true);
      uc.connect();
      uc.getOutputStream().write(("source="+URLEncoder.encode(content)).getBytes());
      uc.getContent();
