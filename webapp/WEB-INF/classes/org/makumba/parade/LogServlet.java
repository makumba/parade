...
{
  static File log= new File(Config.paradeBase+(Config.getProperty("tomcat.output").replace('/', File.separatorChar))); 

  /** this file shows the parts of server-output.txt that are relevant to a certain context. can be improved a lot (e.g. never finish the http transaction, keep sending lines appended to server-output.txt)" */
