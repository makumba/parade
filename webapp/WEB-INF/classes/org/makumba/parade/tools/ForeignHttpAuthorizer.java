...
public class ForeignHttpAuthorizer implements Authorizer
{
  ...
  public static HttpURLConnection sendAuth(URL u,String username, String password)
  ...
  {
	System.out.println
	  (new ForeignHttpAuthorizer
	   ("http://private.best.eu.org:3030/tigro/archive.nsf").auth(argv[0], argv[1]));
	System.out.println
	  (new ForeignHttpAuthorizer
	   ("http://private.best.eu.org:3030/tigro/archive.nsf").auth("shit", "gugu"));
