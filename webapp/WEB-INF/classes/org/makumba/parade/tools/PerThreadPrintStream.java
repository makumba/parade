...
public class PerThreadPrintStream extends java.io.PrintStream
{
  ...
  static ThreadLocal lastEnter= new ThreadLocal(){
    public Object initialValue(){ return dummy; }
  };
  static{
  ...
  public static void set(String o){ prefix.set(o); }
  public static String get(){ return (String)prefix.get(); }
  ...
  PerThreadPrintStream(OutputStream o){ super(o); }
  public void write(byte[] buffer, int start, int len)
  {
	...
	for(int i=start; i<start+len; i++)
	  {
	    if(buffer[i]=='\n') // FIXME, use general line separator here.
	      {
